...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    try {
        $stmt = $conn->prepare("INSERT INTO users (username, password, email, phone, location, user_type) VALUES (?, ?, ?, ?, ?, 'buyer')");
        if ($stmt === false) {
...
<head>
    ...
    <title>Buyer Registration - CarBazaar</title>
            ...
            <div class="auth-form">
                ...
                <form method="POST">
                    ...
                    <div class="auth-footer">
                        ...
                        <p>Want to sell cars? <a href="seller_signup.php">Register as Seller</a></p>
                    </div>
                </form>
            </div>
        </div>
